                    ...
                    <div className="bg-slate-950/60 backdrop-blur-2xl border border-slate-900 shadow-2xl rounded-3xl overflow-hidden">
                        <div className="p-8 md:p-10">
                            ...
                            <div className="space-y-4">
                                <button onClick={() => signIn("google")} className="group w-full h-14 px-6 border border-slate-800 bg-slate-900 hover:bg-slate-850 rounded-full transition-all duration-200 flex items-center justify-center gap-3 shadow-md cursor-pointer hover:border-slate-700">
                                    {/* eslint-disable-next-line @next/next/no-img-element */}
                                ...
                                <button onClick={() => signIn("github")} className="group w-full h-14 px-6 border border-slate-800 bg-slate-900 hover:bg-slate-850 rounded-full transition-all duration-200 flex items-center justify-center gap-3 shadow-md cursor-pointer hover:border-slate-700">
